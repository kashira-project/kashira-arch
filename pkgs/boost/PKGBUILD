...
source=(
  ...
  boost_1_92_0_python_mpi_gcc_16.patch
)
sha256sums=('5c1d40cb8e19adbf740a4ec2da35b3e58f3f5804b1dce44deb53df72193cbc6c'
            'cbea9ce8f511b765bbf139499dce20059f7577b33dcc452014be89299910e69f')

prepare() {
  # https://github.com/boostorg/mpi/issues/179
  patch -Np1 -d $_srcname/libs/mpi -i "${srcdir}/boost_1_92_0_python_mpi_gcc_16.patch"
}
