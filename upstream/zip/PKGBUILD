...
source=("https://downloads.sourceforge.net/infozip/${pkgname}${_pkgver}.tar.gz"
        ...
        'https://sources.debian.org/data/main/z/zip/3.0-16/debian/patches/buffer-overflow-cve-2018-13410.patch'
...
sha256sums=('f0e8bb1f9b7eb0b01285495a2699df3a4b766784c1765a8f1aeedf63c0806369'
            ...
            '39461c3ffd5fbd2a377779855c9e3e87e30e0db235e41256c6547a752da1f388'
            '0905dd62604a4db8d7d9fb2bc228f355e90635fbc32208c21ed72bde1541bdc4')
...
prepare() {
	...
	patch -p1 -i ../buffer-overflow-cve-2018-13410.patch
	patch -p1 -i ../fix-command-injection.patch
}
